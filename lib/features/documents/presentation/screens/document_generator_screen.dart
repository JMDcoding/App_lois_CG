...
class DocumentGeneratorScreen extends StatelessWidget {
  ...
  static final _templates = [
    _Tmpl('Plainte', Icons.report_outlined, 'D̩poser une plainte officielle'),
    _Tmpl('Mise en demeure', Icons.warning_amber_rounded, 'Mettre en demeure une partie'),
    _Tmpl('Contrat simple', Icons.handshake_outlined, 'R̩diger un contrat de base'),
    _Tmpl('Procuration', Icons.how_to_vote_outlined, 'D̩l̩guer un pouvoir'),
    _Tmpl('Lettre administrative', Icons.mail_outlined, 'Correspondance officielle'),
    _Tmpl('D̩claration', Icons.edit_document, 'Faire une d̩claration ̩crite'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('G̩n̩rateur de documents')),
      body: ListView(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('Cr̩ez vos documents', style: TextStyle(
